...
namespace ros4rsb {
    ...
    NavigationServer::NavigationServer(const std::string &name, ros::NodeHandle &node) {
        ...
        clientClearCostmap = node.serviceClient<std_srvs::Empty>("/move_base/clear_costmaps");
        ...
        server->registerMethod("clearCostmap", LocalServer::CallbackPtr(new ClearCostmapCb(this)));
    ...
    bool NavigationServer::clearCostmap() {
        std_srvs::Empty srv;
